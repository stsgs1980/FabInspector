// AUTO-GENERATED — v3.6.6: full Tailwind v4 theme + utilities, unlayered.
// Includes :root CSS variables (--radius-lg, --text-xs, --spacing, etc.) so
// theme-scale utilities work even in consumer projects without Tailwind.
// Backslashes properly escaped for template literal.
export const inspectorCss = `/* FabInspector pre-built CSS — full Tailwind v4 theme + utilities, unlayered for max priority */
:root,:host{--font-sans:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";--font-mono:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;--color-red-50:oklch(97.1% .013 17.38);--color-red-300:oklch(80.8% .114 19.571);--color-red-400:oklch(70.4% .191 22.216);--color-red-500:oklch(63.7% .237 25.331);--color-red-600:oklch(57.7% .245 27.325);--color-amber-200:oklch(92.4% .12 95.746);--color-amber-400:oklch(82.8% .189 84.429);--color-amber-500:oklch(76.9% .188 70.08);--color-amber-600:oklch(66.6% .179 58.318);--color-amber-700:oklch(55.5% .163 48.998);--color-green-400:oklch(79.2% .209 151.711);--color-green-500:oklch(72.3% .219 149.579);--color-green-600:oklch(62.7% .194 149.214);--color-emerald-400:oklch(76.5% .177 163.223);--color-emerald-500:oklch(69.6% .17 162.48);--color-emerald-600:oklch(59.6% .145 163.225);--color-emerald-700:oklch(50.8% .118 165.612);--color-cyan-500:oklch(71.5% .143 215.221);--color-blue-400:oklch(70.7% .165 254.624);--color-blue-500:oklch(62.3% .214 259.815);--color-violet-500:oklch(60.6% .25 292.717);--color-violet-600:oklch(54.1% .281 293.009);--color-purple-400:oklch(71.4% .203 305.504);--color-gray-100:oklch(96.7% .003 264.542);--color-gray-500:oklch(55.1% .027 264.364);--color-zinc-100:oklch(96.7% .001 286.375);--color-zinc-300:oklch(87.1% .006 286.286);--color-zinc-400:oklch(70.5% .015 286.067);--color-zinc-500:oklch(55.2% .016 285.938);--color-zinc-600:oklch(44.2% .017 285.786);--color-zinc-700:oklch(37% .013 285.805);--color-zinc-800:oklch(27.4% .006 286.033);--color-zinc-900:oklch(21% .006 285.885);--color-zinc-950:oklch(14.1% .005 285.823);--color-black:#000;--color-white:#fff;--spacing:.25rem;--container-xs:20rem;--container-sm:24rem;--container-md:28rem;--container-lg:32rem;--container-2xl:42rem;--container-3xl:48rem;--container-4xl:56rem;--container-5xl:64rem;--text-xs:.75rem;--text-xs--line-height:calc(1 / .75);--text-sm:.875rem;--text-sm--line-height:calc(1.25 / .875);--text-base:1rem;--text-base--line-height:calc(1.5 / 1);--text-lg:1.125rem;--text-lg--line-height:calc(1.75 / 1.125);--text-xl:1.25rem;--text-xl--line-height:calc(1.75 / 1.25);--text-2xl:1.5rem;--text-2xl--line-height:calc(2 / 1.5);--font-weight-normal:400;--font-weight-medium:500;--font-weight-semibold:600;--font-weight-bold:700;--tracking-tight:-.025em;--tracking-wide:.025em;--tracking-wider:.05em;--tracking-widest:.1em;--leading-tight:1.25;--leading-snug:1.375;--leading-relaxed:1.625;--radius-xs:.125rem;--radius-sm:.25rem;--radius-md:.375rem;--radius-lg:.5rem;--radius-xl:.75rem;--ease-out:cubic-bezier(0, 0, .2, 1);--ease-in-out:cubic-bezier(.4, 0, .2, 1);--animate-spin:spin 1s linear infinite;--animate-pulse:pulse 2s cubic-bezier(.4, 0, .6, 1) infinite;--blur-sm:8px;--default-transition-duration:.15s;--default-transition-timing-function:cubic-bezier(.4, 0, .2, 1);--default-font-family:var(--font-sans);--default-mono-font-family:var(--font-mono)}
...
.mx-1{margin-inline:var(--spacing)}
...
.scroll-my-1{scroll-margin-block:var(--spacing)}
...
:where(.space-y-0>:not(:last-child)){--tw-space-y-reverse:0;margin-block:0}
...
.border-amber-500\\/20{border-color:#f99c0033}
.border-amber-500\\/40{border-color:#f99c0066}
.border-blue-500\\/20{border-color:#3080ff33}
.border-green-500\\/20{border-color:#00c75833}
.border-green-500\\/30{border-color:#00c7584d}
.border-transparent{border-color:#0000}
.border-violet-500\\/50{border-color:#8d54ff80}
.border-zinc-500\\/20{border-color:#71717b33}
...
.bg-\\[\\#1C2128\\]{background-color:#1c2128}
.bg-\\[\\#1F6FEB\\]{background-color:#1f6feb}
.bg-\\[\\#58A6FF\\]{background-color:#58a6ff}
.bg-\\[\\#161B22\\]{background-color:#161b22}
.bg-\\[\\#21262D\\]{background-color:#21262d}
.bg-\\[\\#30363D\\]{background-color:#30363d}
.bg-amber-500\\/5{background-color:#f99c000d}
.bg-amber-500\\/10{background-color:#f99c001a}
.bg-amber-500\\/15{background-color:#f99c0026}
.bg-black\\/50{background-color:#00000080}
.bg-blue-500\\/5{background-color:#3080ff0d}
.bg-blue-500\\/10{background-color:#3080ff1a}
.bg-blue-500\\/15{background-color:#3080ff26}
.bg-blue-500\\/60{background-color:#3080ff99}
.bg-cyan-500\\/60{background-color:#00b7d799}
.bg-emerald-500\\/10{background-color:#00bb7f1a}
.bg-green-500\\/5{background-color:#00c7580d}
.bg-green-500\\/10{background-color:#00c7581a}
.bg-green-500\\/15{background-color:#00c75826}
.bg-green-500\\/20{background-color:#00c75833}
.bg-green-500\\/60{background-color:#00c75899}
.bg-red-500\\/20{background-color:#fb2c3633}
.bg-transparent{background-color:#0000}
.bg-violet-500{background-color:var(--color-violet-500)}
.bg-violet-500\\/10{background-color:#8d54ff1a}
.bg-violet-600{background-color:var(--color-violet-600)}
.bg-zinc-100{background-color:var(--color-zinc-100)}
.bg-zinc-500\\/5{background-color:#71717b0d}
.bg-zinc-500\\/10{background-color:#71717b1a}
.bg-zinc-500\\/15{background-color:#71717b26}
.bg-zinc-800{background-color:var(--color-zinc-800)}
.bg-zinc-800\\/30{background-color:#27272a4d}
.bg-zinc-800\\/60{background-color:#27272a99}
...
.to-amber-500\\/60{--tw-gradient-to:#f99c0099}
.to-amber-500\\/60{--tw-gradient-stops:var(--tw-gradient-via-stops,var(--tw-gradient-position), var(--tw-gradient-from) var(--tw-gradient-from-position), var(--tw-gradient-to) var(--tw-gradient-to-position))}
...
.text-\\[\\#6E7681\\]{color:#6e7681}
.text-\\[\\#8B949E\\]{color:#8b949e}
.text-\\[\\#58A6FF\\]{color:#58a6ff}
.text-\\[\\#78716c\\]{color:#78716c}
.text-\\[\\#E6EDF3\\]{color:#e6edf3}
.text-\\[\\#E6EDF3\\]\\/80{color:oklab(94.2539% -.00490347 -.0099026/.8)}
.text-\\[\\#F0F6FC\\]{color:#f0f6fc}
.text-\\[\\#FA3913\\]{color:#fa3913}
.text-\\[Npx\\]{color:Npx}
.text-amber-200\\/80{color:#fee685cc}
...
.shadow-\\[0_8px_32px_rgba\\(0\\,0\\,0\\,0\\.4\\)\\]{--tw-shadow:0 8px 32px var(--tw-shadow-color,#0006);box-shadow:var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)}
...
.shadow-\\[\\#1F6FEB\\]\\/30{--tw-shadow-color:#1f6feb4d}
.shadow-black\\/40{--tw-shadow-color:#0006}
...
.\\[file\\:line\\]{file:line}
.group-focus-within\\:opacity-100:is(:where(.group):focus-within *),.group-focus-within\\/code\\:opacity-100:is(:where(.group\\/code):focus-within *),.group-focus-within\\/menu-item\\:opacity-100:is(:where(.group\\/menu-item):focus-within *){opacity:1}
...
.group-data-\\[collapsible\\=icon\\]\\:p-0\\!:is(:where(.group)[data-collapsible=icon] *){padding:0!important}
...
.group-data-\\[collapsible\\=offcanvas\\]\\:w-0:is(:where(.group)[data-collapsible=offcanvas] *){width:0}
.group-data-\\[collapsible\\=offcanvas\\]\\:translate-x-0:is(:where(.group)[data-collapsible=offcanvas] *){--tw-translate-x:0;translate:var(--tw-translate-x) var(--tw-translate-y)}
...
.group-data-\\[side\\=right\\]\\:left-0:is(:where(.group)[data-side=right] *){left:0}
...
.group-data-\\[variant\\=floating\\]\\:rounded-lg:is(:where(.group)[data-variant=floating] *){border-radius:var(--radius-lg)}
...
.group-\\[\\.destructive\\]\\:text-red-300:is(:where(.group).destructive *){color:var(--color-red-300)}
...
.after\\:inset-y-0:after{content:var(--tw-content);inset-block:0}
...
.focus\\:top-4:focus{top:calc(var(--spacing) * 4)}
.focus\\:left-4:focus{left:calc(var(--spacing) * 4)}
.focus\\:z-50:focus{z-index:50}
.focus\\:rounded-md:focus{border-radius:var(--radius-md)}
.focus\\:px-4:focus{padding-inline:calc(var(--spacing) * 4)}
.focus\\:py-2:focus{padding-block:calc(var(--spacing) * 2)}
.focus\\:text-sm:focus{font-size:var(--text-sm);line-height:var(--tw-leading,var(--text-sm--line-height))}
.focus\\:font-medium:focus{--tw-font-weight:var(--font-weight-medium);font-weight:var(--font-weight-medium)}
.focus\\:shadow-lg:focus{--tw-shadow:0 10px 15px -3px var(--tw-shadow-color,#0000001a), 0 4px 6px -4px var(--tw-shadow-color,#0000001a);box-shadow:var(--tw-inset-shadow), var(--tw-inset-ring-shadow), var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow)}
...
.focus-visible\\:ring-\\[\\#58A6FF\\]:focus-visible{--tw-ring-color:#58a6ff}
...
.focus-visible\\:ring-offset-\\[\\#0D1117\\]:focus-visible{--tw-ring-offset-color:#0d1117}
...
.group-\\[\\.destructive\\]\\:focus-visible\\:ring-red-400:is(:where(.group).destructive *):focus-visible{--tw-ring-color:var(--color-red-400)}
.group-\\[\\.destructive\\]\\:focus-visible\\:ring-offset-red-600:is(:where(.group).destructive *):focus-visible{--tw-ring-offset-color:var(--color-red-600)}
...
.data-\\[swipe\\=cancel\\]\\:translate-x-0[data-swipe=cancel]{--tw-translate-x:0;translate:var(--tw-translate-x) var(--tw-translate-y)}
...
.\\[\\&_a\\]\\:break-all a,.\\[\\&_code\\]\\:break-all code{word-break:break-all}
.\\[\\&_li\\:\\:before\\]\\:mr-2 li:before{margin-right:calc(var(--spacing) * 2)}
.\\[\\&_li\\:\\:before\\]\\:font-mono li:before{font-family:var(--font-mono)}
...
.\\[\\&\\+div\\]\\:text-xs+div{font-size:var(--text-xs);line-height:var(--tw-leading,var(--text-xs--line-height))}
